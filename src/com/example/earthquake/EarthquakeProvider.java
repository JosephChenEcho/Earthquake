...
public class EarthquakeProvider extends ContentProvider {	
	...
	private static class earthquakeDatabaseHelper extends SQLiteOpenHelper{
		...
		private static final String DATABASE_CREATE = " create table " + EARTHQUAKE_TABLE + " ( " + KEY_ID + " integer primary key autoincrement, " + KEY_DATE + " INTEGER, "
				+ KEY_DETAILS + " TEXT, " + KEY_LOCATION_LAT + " FLOAT, " + KEY_LOCATION_LNG + " FLOAT, " + KEY_MAGNITUDE + " FLOAT, " + KEY_LINK + " TEXT); ";
	...
	// Create the constants used to differentiate between the dirrerent URI requests
	...
	static{
		...
		uriMatcher.addURI("com.example.provider.Eartherquake", "earthquakes", QUAKES);
		uriMatcher.addURI("com.example.provider.Earthquake", "earthquakes/#", QUAKE_ID);
	}
	...
	public int update(Uri uri, ContentValues values, String where, String[] whereArgs) {
		...
		case QUAKE_ID:
			...
			count = earthquakeDB.update(EARTHQUAKE_TABLE, values, KEY_ID + "=" + segment + (!TextUtils.isEmpty(where) ? " AND (" + where + " ) " : " "), whereArgs);
			break;
